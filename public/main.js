...
document.addEventListener('DOMContentLoaded', () =>{
  ...
  // Add click event listener to all elements with class 'mobile-nav-toggle'
  ...
  function mobileNavToogle() {
    ...
    // Toggle the visibility of elements with classes 
  ...
  document.querySelectorAll('#navbar a').forEach(navbarlink => {
    ...
    navbarlink.addEventListener('click', () => {
      // If the mobile navigation is active, toggle it to hide
